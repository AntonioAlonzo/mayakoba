  ...
  return (
    <>
      <div className="flex flex-wrap justify-center gap-8 mt-10 mx-3">
        ...
        <div className="flex flex-col items-center max-w-[8rem] m-4">
          <div
            onClick={() => handleTypeClick("kids-club")}
            className="cursor-pointer bg-[url('./assets/kids-club.jpg')] bg-center h-[8rem] w-[8rem] md:h-[10rem] md:w-[10rem] bg-cover flex items-center justify-center rounded-full"
          ></div>
